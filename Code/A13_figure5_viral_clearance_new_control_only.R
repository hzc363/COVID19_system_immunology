...
write.csv(dfResult,'Result/A13_clearance_results_auc_control_only.csv',row.names = F)

dfResultAll = read.csv('Result/A13_clearance_results_auc.csv')
...
pdf('Result/A13_viral_correlation_arms.pdf',width = 8,height = 5)  
print(p)
dev.off()
