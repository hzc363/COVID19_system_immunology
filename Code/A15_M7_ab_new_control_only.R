...
write.csv(dfResult,'Result/A15_Ab_M7_results_new_control_only.csv',row.names = F)

dfResultAll = read.csv('Result/A15_Ab_M7_results_new.csv')
...
pdf('Result/A15_severity_correlation_arms_M7.pdf',width = 8,height = 5)  
print(p)
dev.off()
